...
public class PreferenceConfiguration {
    ...
    private static final String SCREEN_ORIENTATION_PREF_STRING = "list_screen_orientation";
    ...
    public static final String GLOBAL_KEYBOARD_CAPTURE_PREF_STRING = "checkbox_global_keyboard_capture";
    ...
    private static final String DEFAULT_SCREEN_ORIENTATION = "landscape";
    ...
    private static final boolean DEFAULT_GLOBAL_KEYBOARD_CAPTURE = false;
    ...
    public boolean globalKeyboardCapture;
    ...
    public static PreferenceConfiguration readPreferences(Context context) {
        ...
        config.globalKeyboardCapture = prefs.getBoolean(GLOBAL_KEYBOARD_CAPTURE_PREF_STRING, DEFAULT_GLOBAL_KEYBOARD_CAPTURE);
        config.screenOrientation = prefs.getString(SCREEN_ORIENTATION_PREF_STRING, DEFAULT_SCREEN_ORIENTATION);
