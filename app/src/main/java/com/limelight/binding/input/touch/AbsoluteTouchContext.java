...
public class AbsoluteTouchContext implements TouchContext {
    ...
    private boolean mMouseLongPressActive;
    ...
    @Override
    public void setMouseLongPressActive(boolean active) {
        mMouseLongPressActive = active;
    }

    /** 获取最后已知的鼠标 X 坐标（相对于 targetView） */
    public int getLastTouchX() {
        return lastTouchLocationX;
    }

    /** 获取最后已知的鼠标 Y 坐标（相对于 targetView） */
